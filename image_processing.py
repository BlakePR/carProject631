...
for images in sorted(os.listdir(badfloor)):
    ...
    RGB_thresh_2 = cv.threshold(RGB_channel_2,30,255,cv.THRESH_BINARY_INV)[1]
    RGB_thresh_22 = cv.threshold(RGB_channel_2, 120, 255, cv.THRESH_BINARY)[1]
    ...
    threshold_HSV1 = cv.threshold(HSV_channel_1,100,255,cv.THRESH_BINARY)[1]
    ...
    # obstacles = cv.bitwise_and(obstacles,RGB_thresh_22)
